...
# load data
x_train = pd.read_csv('/data/yu/dataset/dsmgp/usflight/x_train.csv')
x_test = pd.read_csv('/data/yu/dataset/dsmgp/usflight/x_test.csv')
y_train = pd.read_csv('/data/yu/dataset/dsmgp/usflight/y_train.csv')
y_test = pd.read_csv('/data/yu/dataset/dsmgp/usflight/y_test.csv')
