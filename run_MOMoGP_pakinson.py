...
# load data
x_train = pd.read_csv('/data/yu/dataset/dsmgp/parkinsons/x_train.csv')
x_test = pd.read_csv('/data/yu/dataset/dsmgp/parkinsons/x_test.csv')
y_train = pd.read_csv('/data/yu/dataset/dsmgp/parkinsons/y_train.csv')
y_test = pd.read_csv('/data/yu/dataset/dsmgp/parkinsons/y_test.csv')
